    ...
    <form className="max-w-sm mx-auto">
      ...
      <div className="relative z-0 w-full mb-5 group">
        ...
        <label
          ...
          className="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-pink-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
        >
          Password
        </label>
      </div>
...
export function RegisterForm() {
  return (
    <form className="max-w-md mx-auto">
      ...
      <button
        type="submit"
        className="mt-2 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-full text-sm px-5 py-2.5"
      >
        Submit
      </button>
    </form>
